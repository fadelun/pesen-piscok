...
export default function Modal() {
  ...
  return (
    <>
      {isOpen && (
        <div className="fixed inset-0 bg-gray-800/75 flex items-center z-[999]">
          <div className=" flex flex-col items-center max-w-lg mx-auto gap-4 p-6 rounded-md shadow-md sm:py-8 sm:px-12 bg-white">
            ...
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
              className="w-40 h-40 fill-current shrink-0 dark:text-orange-600"
            >
            ...
            <p className="flex-1 text-center dark:text-gray-600">
              Tempora ipsa quod magnam non, dolores nemo optio. Praesentium
              soluta maiores non itaque aliquam sint.
            </p>
            <button
              type="button"
              className="px-8 py-3 font-semibold rounded-full dark:bg-orange-600 dark:text-gray-50"
...
{
  /* <div className="fixed inset-x-0 inset-y-0 min-w-screen">
<div className=" flex flex-col items-center max-w-lg mx-auto gap-4 p-6 rounded-md shadow-md sm:py-8 sm:px-12 bg-white">
  <button className="absolute top-2 right-2">
    <svg
      xmlns="http://www.w3.org/2000/svg"
